...
def apply_glass_transparent_filter(image, face_landmarks):

    image_height, image_width, _ = image.shape

    glass_filter = cv2.imread("C:/Users/PC/image/glasses_transparent.png", cv2.IMREAD_UNCHANGED)
    ...
    y_pos = int((left_eye_y + right_eye_y) / 2 - glasses_height // 2.2)

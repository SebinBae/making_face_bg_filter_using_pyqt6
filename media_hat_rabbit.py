...
def apply_hat_rabbit_filter(image, face_landmarks,):

    image_height, image_width, _ = image.shape

    hat_filter = cv2.imread("C:/Users/PC/image/hat_rabbit.png", cv2.IMREAD_UNCHANGED)
    ...
    x_offset = forehead_x - hat_width // 2 + 10
    y_offset = max(0, int(forehead_y - hat_height // 1.1))

...
from simulmedia_glass import apply_eye_filter
...
class Real_time_Editor(QMainWindow):
    ...
    def __init__(self):
        ...
        # 필터 이미지 초기화
        self.filter_images = {
            "rabbit_band": "C:/Users/PC/image/hat.png",
            "red_thick_mouth": "C:/Users/PC/image/mouth.png",
            "pig_nose": "C:/Users/PC/image/nose.png",
            "transparent_glasses": "C:/Users/PC/image/glasses.png",
            "pig_ear": "C:/Users/PC/image/nose_hat.png",
            "blue_heart": "C:/Users/PC/image/heart.png",
            "sad_emoticon": "C:/Users/PC/image/face.png"
        }
    ...
    def create_menu_bar(self):
        ...
        head_filter_menu = QMenu("head_filter", self)
        filter_menu.addMenu(head_filter_menu)

        rabbit_band_action = QAction("rabbit band", self)
        rabbit_band_action.triggered.connect(self.on_rabbit_filter_selected)
        head_filter_menu.addAction(rabbit_band_action)

        face_filter_menu = QMenu("face_filter", self)
        filter_menu.addMenu(face_filter_menu)

        sad_emoticon_action = QAction("sad emoticon", self)
        sad_emoticon_action.triggered.connect(self.on_sad_emoticon_selected)
        face_filter_menu.addAction(sad_emoticon_action)

        mouth_filter_menu = QMenu("mouth_filter", self)
        filter_menu.addMenu(mouth_filter_menu)

        red_mouth_action = QAction("red thick mouth", self)
        red_mouth_action.triggered.connect(self.on_red_thick_mouth_selected)
        mouth_filter_menu.addAction(red_mouth_action)

        nose_filter_menu = QMenu("nose_filter", self)
        filter_menu.addMenu(nose_filter_menu)

        pig_nose_action = QAction("pig nose", self)
        pig_nose_action.triggered.connect(self.on_pig_nose_selected)
        nose_filter_menu.addAction(pig_nose_action)

        eye_filter_menu = QMenu("eye_filter", self)
        filter_menu.addMenu(eye_filter_menu)

        transparent_glasses_action = QAction("transparent glasses", self)
        transparent_glasses_action.triggered.connect(self.on_transparent_glasses_selected)
        eye_filter_menu.addAction(transparent_glasses_action)

    def on_rabbit_filter_selected(self):
        path = self.filter_images.get("rabbit_band")
        print(path)
        self.current_filter = cv2.imread(path, cv2.IMREAD_UNCHANGED)
        Real_time_Editor.current_filter_name="rabbit_band"
        #print(f"current_filter 값은 {self.current_filter}입니다.")

    def on_red_thick_mouth_selected(self):
        path = self.filter_images.get("red_thick_mouth")
        print(path)
        self.current_filter = cv2.imread(path, cv2.IMREAD_UNCHANGED)
        Real_time_Editor.current_filter_name= "red_thick_mouth"
        #print(f"{self.filter_images['red_thick_mouth']}")
        #print(f"current_filter 값은 {self.current_filter}입니다.")

    def on_pig_nose_selected(self):
        path = self.filter_images.get("pig_nose")
        print(path)
        self.current_filter = cv2.imread(path, cv2.IMREAD_UNCHANGED)
        Real_time_Editor.current_filter_name= "pig_nose"
        #print(f"current_filter 값은 {self.current_filter}입니다.")

    def on_transparent_glasses_selected(self):
        path = self.filter_images.get("transparent_glasses")
        print(path)
        self.current_filter = cv2.imread(path, cv2.IMREAD_UNCHANGED)
        Real_time_Editor.current_filter_name= "transparent_glasses"
        #print(f"current_filter 값은 {self.current_filter}입니다.")
    ...
    def on_blue_heart_selected(self):
        path = self.filter_images.get("blue_heart")
        print(path)
        self.current_filter = cv2.imread(path, cv2.IMREAD_UNCHANGED)
        Real_time_Editor.current_filter_name= "blue_heart"
        #print(f"current_filter 값은 {self.current_filter}입니다.")

    def on_sad_emoticon_selected(self):
        path = self.filter_images.get("sad_emoticon")
        print(path)
        self.current_filter = cv2.imread(path, cv2.IMREAD_UNCHANGED)
        Real_time_Editor.current_filter_name= "sad_emoticon"
        # print(f"current_filter 값은 {self.current_filter}입니다.")
        #print(f"current_filter 값은 {self.current_filter}입니다.")
        ...
        while self._run_flag:
            ...
            if results.multi_face_landmarks:
                for face_landmarks in results.multi_face_landmarks:
                    if Real_time_Editor.current_filter_name == "rabbit_band":
                        frame = apply_hat_filter(brg_frame, face_landmarks)
                    elif Real_time_Editor.current_filter_name == "red_thick_mouth":
                        frame = apply_mouth_filter(brg_frame, face_landmarks)
                    elif Real_time_Editor.current_filter_name == "pig_nose":
                        frame = apply_nose_filter(brg_frame, face_landmarks)
                    elif Real_time_Editor.current_filter_name == "transparent_glasses": # 클래스 받을 것
                        frame = apply_eye_filter(brg_frame, face_landmarks)
                    elif Real_time_Editor.current_filter_name == "pig_ear":
                        pass
                    elif Real_time_Editor.current_filter_name == "blue_heart":
                        pass
                    elif Real_time_Editor.current_filter_name == "sad_emoticon": # 클래스 받을것
                        frame = apply_face_filter(brg_frame, face_landmarks)

...
def apply_hat_black_filter(image, face_landmarks):

    image_height, image_width, _ = image.shape

    hat_filter = cv2.imread("C:/Users/PC/image/hat_black.png", cv2.IMREAD_UNCHANGED)
    ...
    y_offset = max(0, int(forehead_y - hat_height // 1.5))

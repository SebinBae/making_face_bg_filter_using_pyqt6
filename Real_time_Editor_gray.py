...
class Image_Edit_dark_window(QMainWindow):
    ...
    def get_text_from_user(self):
        ...
        input_dialog.setStyleSheet("""
                       QDialog {
                           background-color: rgb(172,172,172);  /* 다이얼로그 배경색 */
                       ...
                       QLineEdit {
                           background-color: rgb(255,255,255);  /* 텍스트 입력 배경색 */
                           color: black;  /* 텍스트 색상 */
                           padding: 5px;
                           font-size: 14px;
                       ...
                       QPushButton {
                           background-color: rgb(172,172,172);  /* 버튼 색상 */
                       ...
                       QPushButton:hover {
                           background-color: rgb(172,172,172);  /* 호버시 버튼 색상 */
                       }
                       QPushButton:pressed {
                           background-color: rgb(132, 132, 132);  /* 클릭시 버튼 색상 */
                       }
                   """)
    ...
    def get_color_from_user(self):
        ...
        color_dialog.setLabelText(
            "Enter the color, using RGB Format!! then click image(wherever you want to insert to your image: ")
    ...
    def create_rotation_slider(self):
        ...
        self.rotation_slider.setStyleSheet("""
                   QSlider::groove:horizontal {
                       background: rgb(172,172,172); /* 슬라이더 배경색 (밝은 회색) */
                       height: 8px; /* 슬라이더 높이 */
                       border-radius: 4px;
                   }
                   QSlider::handle:horizontal {
                       background: black; /* 슬라이더 핸들 색상 (검정색) */
                   ...
                   QSlider::sub-page:horizontal {
                       background: black; /* 이동한 부분의 색상 (검정색) */
                       border-radius: 4px;
                   }
                   QSlider::add-page:horizontal {
                       background: rgb(172,172,172); /* 남은 부분의 색상 (회색) */
                       border-radius: 4px;
                   }
               """)
...
#이미지 축소 및 확대를 위한 메소드 추가
    def initialize_shift_slider(self):
        ...
        self.shift_slider.setStyleSheet("""
            ...
            QSlider::sub-page:horizontal {background: rgb(172, 172, 172); border-radius: 4px;}
            QSlider::add-page:horizontal {background: rgb(172, 172, 172); border-radius: 4px;}
        """)
    ...
    def create_menu_bar(self):
        ...
        menu_bar.setStyleSheet("""
          QMenuBar {
            ...
            QMenuBar::item {
                background-color: rgb(172,172,172); /* 메뉴 항목의 배경을 투명하게 */
                padding: 5px; /* 여백 추가 */
                color: black; /* 메뉴 항목 텍스트 색상 설정 */
            }
            QMenuBar::item:selected {
                background-color: rgb(139, 139, 139); /* hover 상태 배경색 */
                color: black;
            }
            QMenu {
                background-color: rgb(172,172,172); /* 메뉴 배경색 */
                color: black; /* 메뉴 기본 글자색 *
            }
            QMenu::item {
                background-color: rgb(172,172,172); /* 메뉴 항목 기본 배경색 */
                color: black; /* 메뉴 항목 기본 글자색 */
            }
            QMenu::item:hover {
                background-color: rgb(139, 139, 139); /* hover 상태 배경색 */
                color: black; /* hover 상태 글자색 */
            }
            #hat QMenu::item {
                background-color: rgb(172,172,172); /* 메뉴 항목 기본 배경색 */
                color: black; /* 메뉴 항목 기본 글자색 */
            }
            #hat QMenu::item:hover {
                background-color: rgb(139, 139, 139); /* hover 상태 배경색 */
                color: black; /* hover 상태 글자색 */
            }
            #face QMenu::item {
        ...
        hat_filter_menu.setObjectName("hat")
        ...
        face_filter_menu.setObjectName("face")
        ...
        mouth_lips_action.setObjectName("mouth")
        ...
        nose_filter_menu.setObjectName("nose")
        ...
        glass_filter.setObjectName("glass")
        ...
        move_filter_menu.setObjectName("move")

...
from PyQt6.QtCore import QSize, Qt, pyqtSignal, QDir
...
class MainWindow(QMainWindow):
    ...
    def run_new_window_img_editor(self):
        ...
        self.image_editor_window.closed.connect(self.show_main_window)  # 새 창이 닫히면 메인 창을 다시 표시
...
class Image_Edit_dark_window(QMainWindow):
    ...
    def closeEvent(self, event):
        self.closed.emit()  # 창이 닫힐 때 시그널 발생

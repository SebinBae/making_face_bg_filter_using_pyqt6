...
class Image_Edit_dark_window(QMainWindow):
    ...
    def __init__(self):
        ...
        self.tree.setStyleSheet("""
            QTreeView {
                background-color: rgb(255, 255, 255);  /* 트리뷰 배경색 */
                color: black;  /* 텍스트 색 */
                border: 1px solid black;  /* 테두리 색상 */
            }

            QHeaderView::section {
                background-color: rgb(255, 255, 255);  /* 헤더 배경색 */
            ...
            QTreeView::item:hover {
                background-color: rgba(239, 239, 239, 100); /* 마우스 오버 시 배경색 */
    ...
    def get_text_from_user(self):
        ...
        input_dialog.setStyleSheet("""
                    QDialog {
                        background-color: rgb(255, 255, 255);  /* 다이얼로그 배경색 */
                    ...
                    QPushButton:hover {
                        background-color: rgba(255, 255, 255,100);  /* 호버시 버튼 색상 */
                    }
                    QPushButton:pressed {
                        background-color: rgba(255, 255, 255,100);  /* 클릭시 버튼 색상 */
                    }
                """)
    ...
    def get_color_from_user(self):
        ...
        color_dialog.setStyleSheet("""
                    ...
                    QPushButton {
                        background-color: rgb(255, 255, 255);  /* 버튼 색상 */
                        color: #ffffff;
                        border-radius: 5px;
                        padding: 5px;
                        font-size: 13px;
    ...
    def create_rotation_slider(self):
        ...
        self.rotation_slider.setStyleSheet("""
                QSlider::groove:horizontal {
                    background: rgb(255, 255, 255); /* 슬라이더 배경색 (밝은 회색) */
                    height: 8px; /* 슬라이더 높이 */
                    border-radius: 4px;
                }
                QSlider::handle:horizontal {
                    background: black; /* 슬라이더 핸들 색상 (하얀색) */
                ...
                QSlider::sub-page:horizontal {
                    background: rgba(239, 239, 239, 100); /* 이동한 부분의 색상 (하얀색) */
                    border-radius: 4px;
                }
                QSlider::add-page:horizontal {
                    background: rgba(239, 239, 239, 100); /* 남은 부분의 색상 (회색) */
                    border-radius: 4px;
                }
            """)
    ...
    def initialize_shift_slider(self):
        ...
        self.shift_slider.setStyleSheet("""
            ...
            QSlider::sub-page:horizontal {background: rgb(0,0,0); border-radius: 4px;}
            QSlider::add-page:horizontal {background: rgb(0,0,0); border-radius: 4px;}
        """)
